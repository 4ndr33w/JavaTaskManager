package project.task.manager.user_service.aspect;
...
import project.task.manager.user_service.aspect.dto.LoggingDataDto;
...
public class LoggingAspect {
		...
		private static final Set<String> SENSITIVE_FIELDS = Set.of(
						"password", "token", "accessToken", "refreshToken", "bearer", "Bearer", "Basic"
		);
		...
		@Pointcut("execution(* project.task.manager.user_service.security.component.*.*(..))")
		public void securityComponentsMethods() {}

		@Pointcut("execution(* project.task.manager.user_service.security.filter.*.*(..))")
		public void securityFilterMethods() {}

		@Pointcut("execution(* project.task.manager.user_service.security.*.*(..))")
		...
		private String safeToString(Object obj, String methodName) {
				...
				String exceptionPackageName = "project.task.manager.user_service.exception.";
