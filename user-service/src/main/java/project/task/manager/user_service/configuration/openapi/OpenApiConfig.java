package project.task.manager.user_service.configuration.openapi;
...
public class OpenApiConfig {
	...
	private final static String CONTEXT_PATH = "/user-service";
		...
		public OpenAPI openApi() {
				...
				return new OpenAPI()
								.info(new Info()
												.title("Сервис администрирования пользователей проекта Task Manager")
												.contact(new Contact()
																.name("Andr33w")
																.email("andr33w@example.com"))
												.version("1.0")
												.description("Сервис администрирования пользователей проекта Task Manager"))
						.servers(List.of(
										new Server()
										...
										new Server()
												.url("http://localhost:902" + CONTEXT_PATH)
												.description("Direct access (localhost)"),
										
										new Server()
												.url("http://user-service:902" + CONTEXT_PATH)
